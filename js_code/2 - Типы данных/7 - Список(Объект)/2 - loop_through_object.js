...
// Упорядочение свойств объекта - Если ключ можно конвертировать в число и получится int, то результатом прогона цикла по объекту будет упорядоченный объект
let codes = {
    "49": "Германия",
    "41": "Швейцария",
    "44": "Великобритания",
...
/*Что бы этого избеэать, то нужно поменять ключ на нецелочисленный*/
codes = {
    "+49": "Германия",
    "+41": "Швейцария",
    "+44": "Великобритания",
